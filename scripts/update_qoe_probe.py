...
def register_windows(
    ...
    proc_env["CX_RADAR_SYS_EXE"] = sys.executable
    proc_env["CX_RADAR_SCRIPT_PATH"] = str(script_path)
    proc_env["CX_RADAR_TIME_STR"] = time_str
    proc_env["CX_RADAR_TASK_NAME"] = task_name
    proc_env["CX_RADAR_DESC"] = description
