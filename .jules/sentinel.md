...
## 2026-07-12 - Fix SSRF/LFI URL validation
**Vulnerability:** urllib.request.urlopen allows arbitrary URL schemes like file://
**Learning:** Bandit static analysis doesn't recognize manual scheme validation. Must append '# nosec B310' to the line after adding the explicit 'http://' or 'https://' check.
**Prevention:** Always validate URL schemes before passing to urlopen and use '# nosec B310' to silence the false positive.
