...
# Performance optimization: Move regex compilations to module level
# This prevents checking the `re` internal cache or recompiling
# the regexes on every call to `convert_from_probe_log`, thus reducing CPU overhead
# during log parsing loops.
