...
def register_windows(
    ...
    $action = New-ScheduledTaskAction -Execute $env:CX_RADAR_SYS_EXE -Argument "`"$env:CX_RADAR_SCRIPT_PATH`""
    $trigger = New-ScheduledTaskTrigger -Daily -At $env:CX_RADAR_TIME_STR
    ...
    env_vars["CX_RADAR_TIME_STR"] = time_str
