...
def register_windows(
    ...
    $action = New-ScheduledTaskAction -Execute '{sys.executable}' -Argument "`"$env:TARGET_SCRIPT_PATH`""
    $trigger = New-ScheduledTaskTrigger -Daily -At "$env:TARGET_TIME"
